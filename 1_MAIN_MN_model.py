...
if save == 'y': 
    ...
    np.save(prefix+'parameters', [range_start,range_stop, t_start, end_force, Nb_MN, Cm_rec, Cm_derec_calib, adapt_kR], allow_pickle=True) # PARAMETERS TAKEN FOR SIMULATION
